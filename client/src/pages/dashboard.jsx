      ...
      <main className="flex-1 flex flex-col overflow-y-auto">
        ...
        <div className="px-10 py-6">
          ...
          <div className="mb-10">
            ...
            {/* Card Kanban */}
            <div className="bg-[#17171f] rounded-2xl w-[240px] h-[130px] flex flex-col justify-between p-4 border border-white/5 cursor-pointer hover:bg-[#1f1f2a] transition-colors shadow-lg">
              <h3 className="font-bold text-[14px]">My Kanban Board</h3>
              <div className="w-full h-[1px] bg-white/10 my-1"></div>
              
              {/* Tumpukan Avatar */}
              <div className="flex items-center pt-1">
                <div className="w-7 h-7 rounded-full bg-white flex items-center justify-center z-30 border-2 border-[#17171f]">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#17171f" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                </div>
                <div className="w-7 h-7 rounded-full bg-gray-500 flex items-center justify-center -ml-2 z-20 border-2 border-[#17171f]">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                </div>
                <div className="w-7 h-7 rounded-full bg-red-600 flex items-center justify-center -ml-2 z-10 border-2 border-[#17171f]">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="flex gap-6">
              {/* Card Kanban (Sama seperti di atas) */}
              <div className="bg-[#17171f] rounded-2xl w-[240px] h-[130px] flex flex-col justify-between p-4 border border-white/5 cursor-pointer hover:bg-[#1f1f2a] transition-colors shadow-lg">
                <h3 className="font-bold text-[14px]">My Kanban Board</h3>
                <div className="w-full h-[1px] bg-white/10 my-1"></div>
                <div className="flex items-center pt-1">
              ...
              <div className="bg-[#b3b3b3] rounded-2xl w-[240px] h-[130px] flex flex-col items-center justify-center cursor-pointer hover:bg-[#c9c9c9] transition-colors shadow-lg text-[#17171f]">
