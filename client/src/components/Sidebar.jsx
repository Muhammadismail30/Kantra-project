...
const Sidebar = () => {
  ...
  const location = useLocation(); // Tambahkan ini untuk melacak rute aktif
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col min-w-[260px]"> 
        ...
        <div className="flex flex-col gap-2 mt-6">
          ...
          <button 
            ...
            className={`flex items-center gap-4 px-6 py-3 mx-4 rounded-2xl font-bold transition-colors w-auto text-left ${
              location.pathname === '/dashboard' ? 'bg-[#0a0a0c] text-white' : 'text-white/70 hover:bg-white/5'
            }`}
          >
          ...
          <button 
            ...
            className={`flex items-center gap-4 px-6 py-3 mx-4 rounded-2xl font-bold transition-colors w-auto text-left ${
              location.pathname === '/list' ? 'bg-[#0a0a0c] text-white' : 'text-white/70 hover:bg-white/5'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-4 px-6 py-3 mx-4 rounded-2xl font-bold transition-colors w-auto text-left ${
              location.pathname === '/team' ? 'bg-[#0a0a0c] text-white' : 'text-white/70 hover:bg-white/5'
            }`}
          >
      ...
      <div className="mb-8 min-w-[260px]">
        <button onClick={handleLogout} className="flex items-center gap-4 px-8 py-3 text-white font-bold hover:text-[#7B61FF] transition-colors w-full text-left">
